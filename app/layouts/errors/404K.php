...
<html lang="en">
    ...
    <body>
      ...
      <div class="terminal">
          <p class="prompt">404 :( La página o la ruta que estás buscando no existe. intenta escribir 'kittens' para relajarte.</p>
          <p class="prompt output new-output"></p>
      </div>
      </div>
    </body>
    <script type="text/javascript" src="app\layouts\errors\jquery-1.12.3.min.js"></script>
    <script type="text/javascript" src="app\layouts\errors\velocity.min.js"></script>
